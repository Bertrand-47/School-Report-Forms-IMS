...
<html lang="en">
<head>
    <title>Accounts - School Management System</title>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-10" style="padding-left: 0px">
                <div class="content">
                    <div class="row">
                        <ol class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li class="active">Site Accounts</li>
                        </ol>
                        <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <form method="post" class="savedata">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group form-group-school_list">
                                                            <label class="label-school_list">School</label>
                                                            <select class="form-control school_list"
                                                                    name="school_list">
                                                                <option>Select a school</option>
                                                            </select>
                                                            <span class="text-danger error-school_list"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control permission_selected"
                                                            name="permission_selected">
                                                ...
                                                <div class="form-group school_levelbx" style="display: none">
                                                    <label class="label-school_level">School level</label>
                                                    <select class="form-control school_level"
                                                            name="school_level">
                                                        <option>Select level</option>
                                                    </select>
                                                    <span class="text-danger error-school_level"></span>
                                                </div>
                                                <div class="form-group">
